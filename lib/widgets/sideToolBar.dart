...
import 'package:toktik/tik_tok_icons_icons.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        _getFollowAction(),
        _getSocialAction(icon: Icons.favorite, title: '3.2m',color:Colors.white),
        _getSocialAction(icon: Icons.chat_bubble, title: '16.4k',color:Colors.white),
        _getSocialAction(icon: Icons.reply, title: 'Share',color:Colors.white, isShare: true),
        _getMusicPlayerAction()
      ]),
    );
  }

  Widget _getSocialAction({String title, IconData icon, bool isShare = false, Color color}) {
    return Container(
    ...
    return Positioned(
        ...
        child: Container(
            ...
            child: CachedNetworkImage(
              imageUrl: "https://seeklogo.com/images/P/premier-league-new-logo-D22A0CE87E-seeklogo.com.png",
